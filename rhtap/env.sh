...
export IMAGE_URL=${IMAGE_URL-quay.io/tnevrlka-rhtap/jenkins-eyecatcher:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/tnevrlka-rhtap/jenkins-eyecatcher-gitops
